  ...
  return (
    <AlertDialog open={isOpen} onOpenChange={(open) => open || onClose()}>
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-[24rem_1fr] gap-12 w-full py-4 sm:py-0 [@media(max-width:640px)]:my-4 [@media(max-width:640px)]:pt-[calc(env(safe-area-inset-top)+1rem)] [@media(max-width:640px)]:overflow-y-auto">
