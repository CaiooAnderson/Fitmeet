  ...
  return (
    <div className="flex flex-col gap-1.5 w-80 [@media(max-width:320px)]:w-4/5 [@media(max-width:320px)]:mx-auto">
      ...
      <Popover modal open={openPopover} onOpenChange={setOpenPopover}>
        ...
        <PopoverContent className="flex w-auto flex-col space-y-3 p-3 text-[var(--text)] z-50 [@media(max-width:640px)]:max-h-[60vh] [@media(max-width:640px)]:overflow-auto [@media(max-width:640px)]:touch-action-pan-y">
          <Select
            onValueChange={(value) => {
          ...
          <div className="rounded-lg border [@media(max-width:640px)]:max-h-[250px] [@media(max-width:640px)]:overflow-auto [@media(max-width:640px)]:touch-action-pan-y">
            <Calendar
              mode="single"
